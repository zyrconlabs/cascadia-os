#!/usr/bin/env python3
"""Debrief Operator -- Zyrcon OS -- Post-call and meeting intelligence logger"""
...
PORT          = int(os.environ.get('ZYRCON_PORT', '8008'))
OPERATOR_ID   = 'debrief'
